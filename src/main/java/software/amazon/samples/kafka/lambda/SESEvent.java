...
/**
 * NOTE:
 * SES events are stored inside SNS events. You must unmarshall the SNS event
 * and then unmarshall the message
 * within the SNS event to an SES object. Example is posted on the AWS
 * documentation
...
public class SESEvent implements Serializable, Cloneable {
    ...
    public static class Mail implements Serializable, Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            if (other.getDestination() != null && other.getDestination().equals(this.getDestination()) == false)
                return false;
            if (other.getCallerIdentity() == null ^ this.getCallerIdentity() == null)
                return false;
            if (other.getCallerIdentity() != null && other.getCallerIdentity().equals(this.getCallerIdentity()) == false)
                return false;
            if (other.getHeadersTruncated() == null ^ this.getHeadersTruncated() == null)
                return false;
            if (other.getHeadersTruncated() != null
                    && other.getHeadersTruncated().equals(this.getHeadersTruncated()) == false)
                return false;
        ...
        public int hashCode() {
            ...
            hashCode = prime * hashCode + ((getCallerIdentity() == null) ? 0 : getCallerIdentity().hashCode());
    ...
    public static class BounceRecipient implements Serializable, Cloneable {
        ...
        public BounceRecipient clone() {
            try {
                ...
                throw new IllegalStateException("Got a CloneNotSupportedException emailAddress Object.clone() "
    ...
    public static class Bounce implements Serializable, Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            if (other.getTimestamp() != null && other.getTimestamp().equals(this.getTimestamp()) == false)
                return false;
            if (other.getBouncedRecipients() != null
                    && other.getBouncedRecipients().equals(this.getBouncedRecipients()) == false)
                return false;
    ...
    public static class Complaint implements Serializable, Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            if (other.getComplainedRecipients() == null ^ this.getComplainedRecipients() == null)
                return false;
            if (other.getComplainedRecipients() != null
                    && other.getComplainedRecipients().equals(this.getComplainedRecipients()) == false)
                return false;
            if (other.getTimestamp() == null ^ this.getTimestamp() == null)
                return false;
            if (other.getTimestamp() != null && other.getTimestamp().equals(this.getTimestamp()) == false)
            ...
            if (other.getComplaintFeedbackType() == null ^ this.getComplaintFeedbackType() == null)
                return false;
            if (other.getComplaintFeedbackType() != null
                    && other.getComplaintFeedbackType().equals(this.getComplaintFeedbackType()) == false)
                return false;
        ...
        public int hashCode() {
            ...
            hashCode = prime * hashCode
                    + ((getComplainedRecipients() == null) ? 0 : getComplainedRecipients().hashCode());
            hashCode = prime * hashCode + ((getTimestamp() == null) ? 0 : getTimestamp().hashCode());
            hashCode = prime * hashCode + ((getFeedbackId() == null) ? 0 : getFeedbackId().hashCode());
            hashCode = prime * hashCode + ((getUserAgent() == null) ? 0 : getUserAgent().hashCode());
            hashCode = prime * hashCode
                    + ((getComplaintFeedbackType() == null) ? 0 : getComplaintFeedbackType().hashCode());
    ...
    public static class Delivery implements Serializable, Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            if (other.getProcessingTimeMillis() == null ^ this.getProcessingTimeMillis() == null)
                return false;
            if (other.getProcessingTimeMillis() != null
                    && other.getProcessingTimeMillis().equals(this.getProcessingTimeMillis()) == false)
                return false;
        ...
        public int hashCode() {
            ...
            hashCode = prime * hashCode + ((getTimestamp() == null) ? 0 : getTimestamp().hashCode());
            hashCode = prime * hashCode
                    + ((getProcessingTimeMillis() == null) ? 0 : getProcessingTimeMillis().hashCode());
